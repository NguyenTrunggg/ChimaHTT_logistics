...
export default function FreightForwardingPage() {
  ...
  // Benefits items for freight forwarding
  const freightBenefitItems = [
    {
      titleKey: "freightGlobalNetworkTitle",
      descriptionKey: "freightGlobalNetworkDesc"
    },
    {
      titleKey: "freightDiverseOptionsTitle",
      descriptionKey: "freightDiverseOptionsDesc"
    },
    {
      titleKey: "freightOptimalSolutionTitle",
      descriptionKey: "freightOptimalSolutionDesc"
    },
    {
      titleKey: "freightOnlineTrackingTitle",
      descriptionKey: "freightOnlineTrackingDesc"
    },
    {
      titleKey: "freightQuickProblemSolvingTitle",
      descriptionKey: "freightQuickProblemSolvingDesc"
    },
    {
      titleKey: "freightCompleteServiceTitle",
      descriptionKey: "freightCompleteServiceDesc"
    }
  ]
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <nav className="flex items-center gap-2 text-sm text-gray-600 mb-6">
                ...
                <span>&gt;</span>
                <span className="text-[#00b764]">{t("freightForwardingService")}</span>
              </nav>
              <h1 className="text-4xl md:text-5xl font-bold text-[#1a3b2f] mb-6">{t("freightForwardingService")}</h1>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                {t("internationalFreightDesc")}
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative rounded-xl overflow-hidden h-[400px] lg:h-[500px]">
              <img 
                ...
                alt={t("freightForwardingService")} 
            ...
            <div>
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 bg-[#e8f5ee] rounded-lg flex items-center justify-center mr-4">
                  <Ship className="h-8 w-8 text-[#00b764]" />
                </div>
                <h2 className="text-3xl font-bold text-[#1a3b2f]">{t("freightForwardingService")}</h2>
              </div>

              <div className="text-lg text-gray-600 space-y-4 mb-8">
                <p>{t("internationalFreightDesc")}</p>
                <p>
                  Chi Ma HTT cung cấp dịch vụ giao nhận hàng hóa quốc tế đa phương thức, 
                  giúp doanh nghiệp vận chuyển hàng hóa an toàn, nhanh chóng với chi phí tối ưu nhất.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1a3b2f] mb-4">
              {t("freightBenefitsTitle")}
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              {t("freightBenefitsDesc")}
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {freightBenefitItems.map((benefit, index) => (
