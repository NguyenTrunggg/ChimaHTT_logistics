...
export default function CustomsClearancePage() {
  ...
  // Benefits items for customs clearance
  const clearanceBenefitItems = [
    {
      titleKey: "timeSavingTitle",
      descriptionKey: "timeSavingDesc"
    },
    {
      titleKey: "legalComplianceTitle",
      descriptionKey: "legalComplianceDesc"
    },
    {
      titleKey: "riskMinimizationTitle",
      descriptionKey: "riskMinimizationDesc"
    },
    {
      titleKey: "taxOptimizationClearanceTitle",
      descriptionKey: "taxOptimizationClearanceDesc"
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <nav className="flex items-center gap-2 text-sm text-gray-600 mb-6">
                ...
                <span>&gt;</span>
                <span className="text-[#00b764]">{t("customsClearanceService")}</span>
              </nav>
              <h1 className="text-4xl md:text-5xl font-bold text-[#1a3b2f] mb-6">{t("customsClearanceService")}</h1>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                {t("customsDeclarationDesc")}
              </p>
            ...
            <div>
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 bg-[#e8f5ee] rounded-lg flex items-center justify-center mr-4">
                  <FileText className="h-8 w-8 text-[#00b764]" />
                </div>
                <h2 className="text-3xl font-bold text-[#1a3b2f]">{t("customsClearanceService")}</h2>
              </div>

              <div className="text-lg text-gray-600 space-y-4 mb-8">
                <p>{t("customsDeclarationDesc")}</p>
                <p>
                  Chi Ma HTT cung cấp dịch vụ thông quan chuyên nghiệp, giúp doanh nghiệp hoàn thành thủ tục 
                  hải quan nhanh chóng, chính xác và tuân thủ đầy đủ các quy định pháp luật hiện hành.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1a3b2f] mb-4">
              {t("clearanceBenefitsTitle")}
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              {t("clearanceBenefitsDesc")}
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {clearanceBenefitItems.map((benefit, index) => (
