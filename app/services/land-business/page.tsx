...
export default function LandBusinessPage() {
  const { t } = useLanguage()
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <nav className="flex items-center gap-2 text-sm text-gray-600 mb-6">
                ...
                <span>&gt;</span>
                <span className="text-[#00b764]">{t("landBusinessService")}</span>
              </nav>
              <h1 className="text-4xl md:text-5xl font-bold text-[#1a3b2f] mb-6">{t("landBusinessService")}</h1>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Dịch vụ cho thuê mặt bằng kinh doanh tại vị trí chiến lược cửa khẩu Chi Ma, 
                mang đến không gian kinh doanh lý tưởng cho các doanh nghiệp trong lĩnh vực logistics và thương mại.
              </p>
            ...
            <Card className="shadow-xl">
              ...
              <CardContent className="space-y-4">
                ...
                <Select defaultValue="land">
                  ...
                  <SelectContent>
                    <SelectItem value="land">{t("landBusinessService")}</SelectItem>
            ...
            <div>
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 bg-[#e8f5ee] rounded-lg flex items-center justify-center mr-4">
                  <Building className="h-8 w-8 text-[#00b764]" />
                </div>
                <h2 className="text-3xl font-bold text-[#1a3b2f]">{t("landBusinessService")}</h2>
              </div>

              <div className="text-lg text-gray-600 space-y-4 mb-8">
                <p>
                  Chi Ma HTT cung cấp dịch vụ cho thuê mặt bằng kinh doanh tại vị trí đắc địa của cửa khẩu Chi Ma, 
                  mang đến không gian kinh doanh lý tưởng cho các doanh nghiệp trong lĩnh vực logistics và thương mại.
                </p>
                <p>
                  Với cơ sở hạ tầng hiện đại và vị trí chiến lược, chúng tôi cam kết mang đến giải pháp mặt bằng 
                  kinh doanh phù hợp với nhu cầu của từng doanh nghiệp.
                </p>
              </div>
                  ...
                  {features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        {feature === "strategicLocation" ? "Vị trí đắc địa" :
                         feature === "modernFacilities" ? "Cơ sở vật chất hiện đại" :
                         feature === "flexibleRental" ? "Thời gian thuê linh hoạt" :
                         feature === "customSolutions" ? "Giải pháp tùy chỉnh" :
                         feature === "professionalManagement" ? "Quản lý chuyên nghiệp" : feature}
                      </span>
                    </li>
                  ))}
                </ul>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1a3b2f] mb-4">
              Lợi ích của dịch vụ cho thuê mặt bằng
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Không gian kinh doanh hiện đại tại vị trí chiến lược cửa khẩu Chi Ma
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Nằm tại cửa khẩu Chi Ma, thuận lợi cho thương mại Việt - Trung"
              },
              {
                title: "Cơ sở hạ tầng hiện đại",
                description: "Hệ thống điện, nước, internet tốc độ cao, hệ thống PCCC hiện đại"
              },
              {
                title: "An ninh 24/7",
                description: "Hệ thống an ninh nghiêm ngặt, đảm bảo an toàn cho tài sản kinh doanh"
              },
              {
                title: "Dịch vụ quản lý chuyên nghiệp",
                description: "Đội ngũ quản lý tòa nhà chuyên nghiệp, hỗ trợ 24/7"
              },
              {
                title: "Kết nối hệ sinh thái",
                description: "Kết nối với các dịch vụ logistics và hải quan trong hệ sinh thái Chi Ma HTT"
              },
              {
                title: "Điều khoản linh hoạt",
                description: "Thời hạn hợp đồng linh hoạt phù hợp với nhu cầu kinh doanh của bạn"
              }
            ].map((benefit, index) => (
              <Card key={index} className="shadow-lg border-none">
                <CardContent className="pt-8">
                  ...
                  <h3 className="text-xl font-bold text-[#1a3b2f] mb-3">{benefit.title}</h3>
