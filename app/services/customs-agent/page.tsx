...
export default function CustomsAgentPage() {
  const { t } = useLanguage()
  ...
  const benefitItems = [
    ...
    {
      titleKey: "representationTitle",
      descriptionKey: "representationDesc"
    },
    {
      titleKey: "policyConsultingTitle",
      descriptionKey: "policyConsultingDesc"
    },
    {
      titleKey: "taxOptimizationTitle",
      descriptionKey: "taxOptimizationDesc"
    },
    {
      titleKey: "legalRiskReductionTitle",
      descriptionKey: "legalRiskReductionDesc"
    },
    {
      titleKey: "resourceSavingTitle",
      descriptionKey: "resourceSavingDesc"
    }
  ]
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <nav className="flex items-center gap-2 text-sm text-gray-600 mb-6">
                ...
                <span>&gt;</span>
                <span className="text-[#00b764]">{t("customsAgentService")}</span>
              </nav>
              <h1 className="text-4xl md:text-5xl font-bold text-[#1a3b2f] mb-6">{t("customsAgentService")}</h1>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                {t("importExportConsultingDesc")}
              </p>
              ...
              <CardContent className="space-y-4">
                ...
                <Select defaultValue="agent">
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="agent">{t("customsAgentService")}</SelectItem>
            ...
            <div>
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 bg-[#e8f5ee] rounded-lg flex items-center justify-center mr-4">
                  <Truck className="h-8 w-8 text-[#00b764]" />
                </div>
                <h2 className="text-3xl font-bold text-[#1a3b2f]">{t("customsAgentService")}</h2>
              </div>

              <div className="text-lg text-gray-600 space-y-4 mb-8">
                <p>{t("importExportConsultingDesc")}</p>
                <p>
                  Chi Ma HTT với vai trò là đại lý hải quan chính thức, cung cấp dịch vụ đại diện cho doanh nghiệp 
                  trong việc thực hiện các thủ tục hải quan, đảm bảo quy trình xuất nhập khẩu diễn ra suôn sẻ, hiệu quả.
                </p>
              </div>
