...
export default function PassengerTransitPage() {
  const { t } = useLanguage();
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <nav className="flex items-center gap-2 text-sm text-gray-600 mb-6">
                ...
                <span>&gt;</span>
                <span className="text-[#00b764]">{t("passengerTransitCenter")}</span>
              </nav>
              <h1 className="text-4xl md:text-5xl font-bold text-[#1a3b2f] mb-6">{t("passengerTransitCenter")}</h1>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                {t("passengerTransitDesc")}
              </p>
            ...
            <Card className="shadow-xl">
              ...
              <CardContent className="space-y-4">
                ...
                <Select defaultValue="transit">
                  ...
                  <SelectContent>
                    <SelectItem value="transit">{t("passengerTransitCenter")}</SelectItem>
            ...
            <div>
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 bg-[#e8f5ee] rounded-lg flex items-center justify-center mr-4">
                  <Users className="h-8 w-8 text-[#00b764]" />
                </div>
                <h2 className="text-3xl font-bold text-[#1a3b2f]">{t("passengerTransitCenter")}</h2>
              </div>

              <div className="text-lg text-gray-600 space-y-4 mb-8">
                <p>{t("passengerTransitDesc")}</p>
                <p>
                  Chi Ma HTT cung cấp dịch vụ trung chuyển hành khách cao cấp tại cửa khẩu Chi Ma, 
                  giúp quá trình xuất nhập cảnh diễn ra thuận lợi với các tiện nghi hiện đại và dịch vụ chuyên nghiệp.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1a3b2f] mb-4">
              Lợi ích của trung tâm trung chuyển hành khách
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Trải nghiệm xuất nhập cảnh thuận lợi với dịch vụ tiện nghi và chuyên nghiệp
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Phòng chờ rộng rãi, tiện nghi với khu vực nghỉ ngơi riêng tư"
              },
              {
                title: "Hỗ trợ thủ tục nhanh chóng",
                description: "Đội ngũ chuyên viên hỗ trợ hoàn tất thủ tục xuất nhập cảnh nhanh chóng"
              },
              {
                title: "Dịch vụ ăn uống đa dạng",
                description: "Đồ ăn, thức uống chất lượng cao phục vụ 24/7 tại trung tâm"
              },
              {
                title: "Phiên dịch chuyên nghiệp",
                description: "Đội ngũ phiên dịch Việt-Trung-Anh hỗ trợ giao tiếp"
              },
              {
                title: "Dịch vụ đưa đón",
                description: "Xe đưa đón tận nơi với lịch trình linh hoạt theo yêu cầu"
              },
              {
                title: "An ninh nghiêm ngặt",
                description: "Hệ thống an ninh hiện đại đảm bảo an toàn cho hành khách"
              }
            ].map((benefit, index) => (
